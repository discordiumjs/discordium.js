 ...
 */
export const MaxBulkDeletableMessageAge: number = 1_209_600_000;
 ...
 */
export const SweeperKeys: string[] = [
  'autoModerationRules',
  'applicationCommands',
  'bans',
  'emojis',
 ...
 */
export const NonSystemMessageTypes: MessageType[] = [
  MessageType.Default,
  MessageType.Reply,
 ...
 */
export const GuildTextBasedChannelTypes: ChannelType[] = [
 ...
 */
export const TextBasedChannelTypes: ChannelType[] = [...GuildTextBasedChannelTypes, ChannelType.DM, ChannelType.GroupDM];
 ...
 */
export const SendableChannels: ChannelType[] = [...GuildTextBasedChannelTypes, ChannelType.DM];
 ...
 */
export const ThreadChannelTypes: ChannelType[] = [ChannelType.AnnouncementThread, ChannelType.PublicThread, ChannelType.PrivateThread];
 ...
 */
export const VoiceBasedChannelTypes: ChannelType[] = [ChannelType.GuildVoice, ChannelType.GuildStageVoice];
 ...
 */
export const SelectMenuTypes: ComponentType[] = [
 ...
 */
export const UndeletableMessageTypes: MessageType[] = [
 ...
 */
export const StickerFormatExtensionMap: Record<StickerFormatType, ImageFormat> = {
